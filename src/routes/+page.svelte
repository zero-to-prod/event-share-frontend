...
<div class="py-10 from-primary to-secondary bg-gradient-to-br pt-20 text-white">
  <div class="max-w-7xl m-auto">
    <div class="lg:pl-10 lg:pb-32">
      <div class="flex">
        <div>
          <h1 class="mb-2 flex font-bold text-6xl">
            eventSHARE <svg
              class="h-8 mt-1 ml-1 fill-white"
              focusable="false"
              aria-hidden="true"
              viewBox="0 0 22 22"
            >
          ...
          <h2 class="font-semibold">a better way to share events</h2>
          <div>
            <h3>How it Works</h3>
        ...
        <form on:submit|preventDefault={onSubmit}>
          <div class="form-control">
            ...
            <input
              bind:value={name}
              class="input-bordered bg-transparent"
              id="name"
              name="name"
              title="Name"
              minlength="2"
